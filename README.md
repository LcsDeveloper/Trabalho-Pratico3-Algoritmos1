...
![Evolução do tempo para instâncias do Moodle](gráficos/Evolução do tempo para instâncias do Moodle.png)  
*Figura 1: Evolução do tempo para instâncias do Moodle (Eixo X: Magnitude das instâncias; Eixo Y: Tempo em milissegundos)*

![Comparação entre tempos de execução](gráficos/Comparação entre tempos de execução.png)  
...
![Qualidade da aproximação](gráficos/Qualidade da aproximação (Instâncias do Moodle).png)  
*Figura 3: Qualidade da aproximação (Eixo X: Magnitude das instâncias; Eixo Y: Movimentos para captura)*

![Dispersão da solução aproximativa](gráficos/Dispersão da solução aproximativa.png)  
